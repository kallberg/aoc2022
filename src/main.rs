...
fn main() {
    let solvers: Vec<BoxedSolver> = vec![
        ...
        Box::new(day12pt1::solve),
        Box::new(day12pt2::solve),
    ];
    ...
    let inputs = vec![
        ...
        include_str!("../input/day11pt1.txt"),
        include_str!("../input/day12pt1.txt"),
        include_str!("../input/day12pt1.txt"),
    ];
...
mod tests {
    use crate::{
        day10pt1, day10pt2, day11pt1, day11pt2, day12pt1, day12pt2, day1pt1, day1pt2, day2pt1,
        day2pt2, day3pt1, day3pt2, day4pt1, day4pt2, day5pt1, day5pt2, day6pt1, day6pt2, day7pt1,
        day7pt1::Directory, day7pt2, day8pt1, day8pt1::TreeGrid, day8pt2, day9pt1, day9pt2,
    };
...
#######.......#######.......#######....."
    ...
    #[test]
    fn day12pt1_eq_example() {
        let input = include_str!("../example_input/day12pt1.txt");

        assert_eq!(day12pt1::solve(input), "31");
    }
